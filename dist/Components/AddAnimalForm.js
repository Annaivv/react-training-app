...
const DialogContentText_1 = __importDefault(
...
const AddNewAnimalForm = ({ open, handleCloseForm, handleAddAnimal }) => {
    ...
    return React.createElement(
        Dialog_1.default,
        { open: open, onClose: handleCloseForm },
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(react_hook_form_1.Controller, {
                    name: 'name',
                    control: control,
                    defaultValue: '',
                    rules: {
